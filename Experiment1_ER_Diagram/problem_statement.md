...
### ER Diagram:
<img width="752" height="422" alt="image" src="https://github.com/user-attachments/assets/91ceebe8-ca76-4ea2-8c66-843634c015e2" /> 
...
<img width="728" height="852" alt="image" src="https://github.com/user-attachments/assets/298c5e3b-de83-432a-85f3-ff45a2e293d3" />
...
-    BookCopy entity is not modeled.

-   Rooms are shared for both events and study bookings.
...
<img width="1009" height="603" alt="image" src="https://github.com/user-attachments/assets/a10e91c8-adf7-48a4-91fa-428bcf88e3b9" />
...
| Relationship                     | Cardinality | Participation                | Notes                                                                     |
| -------------------------------- | ----------- | ---------------------------- | ------------------------------------------------------------------------- |
| Prepares (CHEF – MEAL)           | 1 : N       | CHEF (total), MEAL (partial) | One chef prepares many meals; each meal prepared by one chef              |
| Orders (CUSTOMERS – MEAL)        | M : N       | Both partial                 | Customers can order many meals; meals can be ordered by many customers    |
| Consists Of (MEAL – INGREDIENTS) | M : N       | Both total                   | Each meal has multiple ingredients; ingredients can be used in many meals |
